...
public final class TimeDialog {
    ...
    public static final class Builder extends CommonDialog.Builder<Builder> implements Runnable {
        ...
        public Builder(Context context) {
            ...
            mHourManager = new PickerLayoutManager.Builder(context).build();
            mMinuteManager = new PickerLayoutManager.Builder(context).build();
            mSecondManager = new PickerLayoutManager.Builder(context).build();
        ...
        @Override
        public void run() {
            if (mHourView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE && mMinuteView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE && mSecondView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE) {
                Calendar calendar = Calendar.getInstance();
